...
mlflow.set_experiment("tourism_project_prediction_experiment")     # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
numeric_features = ["Age", "CityTier", "DurationOfPitch", "NumberOfPersonVisiting",
    ...
    "PitchSatisfactionScore", "NumberOfChildrenVisiting", "MonthlyIncome"]   # complete the code to list all numerical feature names (same as in prep.py)

categorical_features = ["TypeofContact", "Occupation", "Gender", "ProductPitched",
    "MaritalStatus", "Passport", "OwnCar", "Designation"]   # complete the code to list all categorical feature names (same as in prep.py)
...
xgb_model = xgb.XGBClassifier(scale_pos_weight=class_weight, random_state=33)
...
param_grid = {
    ...
    'xgbclassifier__reg_lambda': [1, 2, 5],          # L2 regularization strength. Higher values help reduce overfitting.
}
# Model pipeline
